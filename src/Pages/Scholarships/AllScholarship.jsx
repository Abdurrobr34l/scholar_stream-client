  ...
  return (
    <section className='sectionPadding'>
      <Container>
        ...
        <SectionTitle sectionName={`Total Scholarships: ${data.length}`} customStyle={"text-start"}></SectionTitle>

        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
          {data.map(({ _id, universityName, universityImage, universityCity, universityCountry, scholarshipCategory, applicationFees }, index) => (
            <motion.div
              key={_id}
