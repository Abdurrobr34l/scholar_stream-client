...
const PrimaryButton = ({ path, buttonName, icon: Icon }) => {
  return (
    <Link
      to={path}
      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-semibold shadow-soft bg-primary text-white transition-colors duration-300 ease-linear hover:bg-accent hover:text-primary"
    >
